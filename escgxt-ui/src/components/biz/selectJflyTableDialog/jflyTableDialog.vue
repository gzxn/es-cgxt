						...
						<el-card class="leftCard">
							...
							<div class="dataTable autoFlex" v-if="selectListData">
								<el-table ref="selectTable" class="table" :data="selectListData" stripe border
									...
									<el-table-column v-if="multiple" type="selection" width="55" fixed="left"></el-table-column>
									<el-table-column prop="ysmc" label="预算项目名称" width= "110"></el-table-column>
									<el-table-column prop="ysbm" label="预算项目编码" sortable width= "130"></el-table-column>
									<el-table-column prop="dname" label="经办部门" width= "140"></el-table-column>
									<el-table-column prop="dcode" label="经办部门编码" sortable width= "130"></el-table-column>
									<!-- <el-table-column prop="jbbm" label="经办部门" width= "110"></el-table-column>
									<el-table-column prop="jbbmbm" label="经办部门编码" sortable width= "130"></el-table-column> -->
									<el-table-column prop="year" label="年度" width= "100"></el-table-column>
									<el-table-column prop="jfType" label="经费类型" width= "110"></el-table-column>
								</el-table>
								<div class="pageBar">
						...
						<el-card class="rightCard">
							...
							<div class="dataTable autoFlex">
								<el-table class="table" :data="selectedListData" stripe border height="auto">
									<el-table-column prop="ysmc" label="预算项目名称" width= "110"></el-table-column>
									<el-table-column prop="ysbm" label="预算项目编码" width= "110"></el-table-column>
									<el-table-column prop="dname" label="经办部门" width= "140"></el-table-column>
									<el-table-column prop="dcode" label="经办部门编码" width= "110"></el-table-column>
									<el-table-column prop="year" label="年度" width= "70"></el-table-column>
									<el-table-column prop="jfType" label="经费类型" width= "120"></el-table-column>
	...
	export default {
		...
		methods: {
			...
			list() {
				...
				api.list(params, response => {debugger
