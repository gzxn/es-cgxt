...
let ApiUtils = {
	getAjax: function(url, params, successCallback, failCallback, exceptionCallback) {
		ApiUtils.sendAjax(url, "get", null, params, null, successCallback, failCallback, exceptionCallback, false);
	},
	getLoadingAjax: function(url, params, successCallback, failCallback, exceptionCallback) {
		ApiUtils.sendAjax(url, "get", null, params, null, successCallback, failCallback, exceptionCallback, true);
	},
	postAjax: function(url, data, successCallback, failCallback, exceptionCallback) {
		ApiUtils.sendAjax(url, "post", data, null, null, successCallback, failCallback, exceptionCallback, false);
	},
	postLoadingAjax: function(url, data, successCallback, failCallback, exceptionCallback) {
		ApiUtils.sendAjax(url, "post", data, null, null, successCallback, failCallback, exceptionCallback, true);
	},
	putAjax: function(url, data, successCallback, failCallback, exceptionCallback) {
		ApiUtils.sendAjax(url, "put", data, null, null, successCallback, failCallback, exceptionCallback, false);
	},
	...
	deleteAjax: function(url, params, successCallback, failCallback, exceptionCallback) {
		ApiUtils.sendAjax(url, "delete", null, params, null, successCallback, failCallback, exceptionCallback, false);
	},
	deleteLoadingAjax: function(url, params, successCallback, failCallback, exceptionCallback) {
		ApiUtils.sendAjax(url, "delete", null, params, null, successCallback, failCallback, exceptionCallback, true);
	},
	...
	sendAjax: function(url, method, data, params, headers, successCallback, failCallback, exceptionCallback, isLoading) {
		...
		_axios({
			...
			ApiUtils.baseCallBack(url, method, data, params, response, successCallback, failCallback, exceptionCallback);
		}, error => {
			if (messageObj) {
				messageObj.close();
			}
