	...
	<div class="tab-body">
        ...
        <div class="dataTable autoFlex" v-if="listData">
			<el-table class="table" :data="listData.records" stripe border height="auto" @selection-change="selectionChange" v-loading="listLoading">
						...
						<el-table-column prop="cgrwbh" label="采购任务编号"></el-table-column>
						<el-table-column prop="cgrwmc" label="采购任务名称"></el-table-column>
						...
						<el-table-column prop="dljgmc" label="代理机构名称"></el-table-column>
						<el-table-column prop="cgzxr" label="采购执行人"></el-table-column>
						<el-table-column prop="zxbm" label="执行部门"></el-table-column> 
						<el-table-column prop="sbrq" label="申报日期"></el-table-column>
						<el-table-column prop="isDjjg" label="是否登记结果"></el-table-column>
						<el-table-column prop="cqfs" label="抽取方式"></el-table-column>
