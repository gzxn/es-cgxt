				...
				<qlh-table-column label="操作" fixed="right" width="180px">
					<template slot-scope="scope">
						<div class="dataTable-operator">
							<el-button v-has-permission-code-and="'2000014005'" size="mini" icon="el-icon-search"@click="toDetail(scope.$index, scope.row)">详情</el-button>
...
<script>
	...
	import cgrwApi from '@/api/ebp_cgrw/ebp_cgrw/ebp_cgrw.js';
	...
	export default {
		...
		methods: {
			...
			toDetail(index, row) {
				...
				this.$refs.edit.open(detailParameter, '详情', true, '70%');
			},
			//删除
			remove(index, row) {
				let parameter = {
