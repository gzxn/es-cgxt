	...
	<div class="tab-body">
        ...
        <div class="dataTable autoFlex" v-if="listData">
			<el-table class="table" :data="listData.records" stripe border height="auto" @selection-change="selectionChange" v-loading="listLoading">
						...
						<el-table-column prop="zbxmbh" label="招标项目编号"></el-table-column>
						...
						<el-table-column prop="isZbdj" label="是否已登记中标结果：0-否、1-是"></el-table-column>
						<el-table-column prop="manageDepart" label="归口部门"></el-table-column>
