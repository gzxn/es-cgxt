	...
	<div class="tab-body">
        ...
        <div class="dataTable autoFlex" v-if="listData">
			<el-table class="table" :data="listData.records" stripe border height="auto" @selection-change="selectionChange" v-loading="listLoading">
						...
						<el-table-column prop="cgbbh" label="采购包编号"></el-table-column>
						<el-table-column prop="cgbmc" label="采购包名称"></el-table-column>
						...
						<el-table-column prop="cgzxryhm" label="采购执行人用户名"></el-table-column>
						<el-table-column prop="cgzxr" label="采购执行人"></el-table-column>
						<el-table-column prop="cqfs" label="代理机构抽取方式"></el-table-column>
						<el-table-column prop="xmlx" label="项目类型"></el-table-column>
						<el-table-column prop="bpmStatus" label="流程状态"></el-table-column>
						<el-table-column prop="dljgbh" label="代理机构编号"></el-table-column>
						<el-table-column prop="dljgid" label="代理机构id"></el-table-column>
						<el-table-column prop="isProxy" label="是否走代理流程：0-否、1-是"></el-table-column>
						<el-table-column prop="isWt" label="是否委托：0-否、1-是"></el-table-column>
						<el-table-column prop="isTs" label="是否已推送：0-否、1-是"></el-table-column>
						<el-table-column prop="isZb" label="是否生成至招标项目：0-否、1-是"></el-table-column>
