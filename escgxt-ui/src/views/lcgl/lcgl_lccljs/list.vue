	...
	<div class="tab-body">
        ...
        <div class="dataTable autoFlex" v-if="listData">
			<el-table class="table" :data="listData.records" stripe border height="auto" @selection-change="selectionChange" v-loading="listLoading">
						...
						<el-table-column prop="cljsdm" label="处理角色代码"></el-table-column>
						<el-table-column prop="cljs" label="处理角色"></el-table-column>
...
import api from '@/api/lcgl/lcgl_lccljs/lcgl_lccljs.js';
export default {
	name: 'lcgl_lccljs',
	components: {
		edit
