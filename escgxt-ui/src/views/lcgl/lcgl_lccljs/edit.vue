	...
	<popup ref="popup" :loading="popupLoading">
		<div slot="body">
			<el-form class="dataForm" ref="form" :disabled="disabled" :model="formParameter" :inline="true" label-width="80px" :rules="rules">
					...
					<el-row>
						<el-col :span="24">
							<el-form-item label="处理角色代码" prop="cljsdm"><el-input v-model="formParameter.cljsdm" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
							<el-form-item label="处理角色" prop="cljs"><el-input v-model="formParameter.cljs" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
