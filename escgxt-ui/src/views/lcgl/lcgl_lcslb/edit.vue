	...
	<popup ref="popup" :loading="popupLoading">
		<div slot="body">
			<el-form class="dataForm" ref="form" :disabled="disabled" :model="formParameter" :inline="true" label-width="80px" :rules="rules">
					...
					<el-row>
						<el-col :span="24">
							<el-form-item label="详情id" prop="xqid"><el-input v-model="formParameter.xqid" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
					...
					<el-row>
						<el-col :span="24">
							<el-form-item label="申请人" prop="sqr"><el-input v-model="formParameter.sqr" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
					...
					<el-row>
						<el-col :span="24">
							<el-form-item label="数据表单主键" prop="sjbdzj"><el-input v-model="formParameter.sjbdzj" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
							<el-form-item label="元数据id" prop="ysjid"><el-input v-model="formParameter.ysjid" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
					...
					<el-row>
						<el-col :span="24">
							<el-form-item label="当前任务id" prop="dqrwid"><el-input v-model="formParameter.dqrwid" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
							<el-form-item label="当前任务" prop="dqrw"><el-input v-model="formParameter.dqrw" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
							<el-form-item label="历史处理人" prop="lsclr"><el-input v-model="formParameter.lsclr" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
