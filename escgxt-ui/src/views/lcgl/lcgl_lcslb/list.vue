	...
	<div class="tab-body">
        ...
        <div class="dataTable autoFlex" v-if="listData">
			<el-table class="table" :data="listData.records" stripe border height="auto" @selection-change="selectionChange" v-loading="listLoading">
						...
						<el-table-column prop="xqid" label="详情id"></el-table-column>
						...
						<el-table-column prop="sjbdzj" label="数据表单主键"></el-table-column>
						<el-table-column prop="ysjid" label="元数据id"></el-table-column>
						<el-table-column prop="ssbm" label="所属表名"></el-table-column>
						<el-table-column prop="dqrwid" label="当前任务id"></el-table-column>
						<el-table-column prop="dqrw" label="当前任务"></el-table-column>
						<el-table-column prop="lsclr" label="历史处理人"></el-table-column>
...
import api from '@/api/lcgl/lcgl_lcslb/lcgl_lcslb.js';
export default {
	name: 'lcgl_lcslb',
	components: {
		edit
