	...
	<popup ref="popup" :loading="popupLoading">
		<div slot="body">
			<el-form class="dataForm" ref="form" :disabled="disabled" :model="formParameter" :inline="true" label-width="80px" :rules="rules">
					<el-row>
						<el-col :span="24">
							<el-form-item label="任务表id" prop="rwid"><el-input v-model="formParameter.rwid" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
					...
					<el-row>
						<el-col :span="24">
							<el-form-item label="处理时间" prop="clsj"><el-input v-model="formParameter.clsj" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
							<el-form-item label="审核意见" prop="shyj"><el-input v-model="formParameter.shyj" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
					...
					<el-row>
						<el-col :span="24">
							<el-form-item label="操作类型" prop="czlx"><el-input v-model="formParameter.czlx" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
...
import api from '@/api/lcgl/lcgl_lzlsb/lcgl_lzlsb.js';
export default {
	name: 'edit',
	components: {
			popup
