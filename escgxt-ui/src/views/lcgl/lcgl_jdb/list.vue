	...
	<div class="tab-body">
        ...
        <div class="dataTable autoFlex" v-if="listData">
			<el-table class="table" :data="listData.records" stripe border height="auto" @selection-change="selectionChange" v-loading="listLoading">
						...
						<el-table-column prop="jyclsj" label="建议处理时间"></el-table-column>
						<el-table-column prop="bxsftg" label="并行是否通过"></el-table-column>
						<el-table-column prop="dlrjt" label="待理人监听"></el-table-column>
						<el-table-column prop="dqrw" label="是否当前任务节点"></el-table-column>
						<el-table-column prop="clr" label="处理人"></el-table-column>
						<el-table-column prop="clryhm" label="处理人用户名"></el-table-column>
						<el-table-column prop="sfksjsjd" label="是否开始结束节点"></el-table-column>
						<el-table-column prop="clfs" label="处理方式"></el-table-column>
						<el-table-column prop="ssbm" label="所属表名"></el-table-column>
						<el-table-column prop="jdmc" label="节点名称"></el-table-column>
						<el-table-column prop="lcid" label="流程id"></el-table-column>
						<el-table-column prop="bdzj" label="表单主键"></el-table-column>
						<el-table-column prop="lcslid" label="流程实例id"></el-table-column>
						<el-table-column prop="sxh" label="顺序号"></el-table-column>
						<el-table-column prop="sfhq" label="是否会签"></el-table-column>
						<el-table-column prop="zxjdjt" label="处理节点监听"></el-table-column>
						<el-table-column prop="tgyshr" label="跳过已审核人"></el-table-column>
						<el-table-column prop="tjbds" label="条件表达式"></el-table-column>
						<el-table-column prop="jdbm" label="节点编码"></el-table-column>
						<el-table-column prop="sfbgjd" label="必过节点：0-否、1-是"></el-table-column>
