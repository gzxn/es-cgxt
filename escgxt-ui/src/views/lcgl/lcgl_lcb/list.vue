	...
	<div class="tab-body">
        ...
        <div class="dataTable autoFlex" v-if="listData">
			<el-table class="table" :data="listData.records" stripe border height="auto" @selection-change="selectionChange" v-loading="listLoading">
						...
						<el-table-column prop="xqurl" label="详情URL"></el-table-column>
						<el-table-column prop="lcmc" label="流程名称"></el-table-column>
						<el-table-column prop="ms" label="描述"></el-table-column>
						<el-table-column prop="ysjzj" label="元数据主键"></el-table-column>
						<el-table-column prop="ssbm" label="所属表名"></el-table-column>
						<el-table-column prop="sfsxqm" label="是否手写签名：0-否、1-是"></el-table-column>
...
import api from '@/api/lcgl/lcgl_lcb/lcgl_lcb.js';
export default {
	name: 'lcgl_lcb',
	components: {
		edit
