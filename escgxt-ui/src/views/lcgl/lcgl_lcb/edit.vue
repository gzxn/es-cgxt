	...
	<popup ref="popup" :loading="popupLoading">
		<div slot="body">
			<el-form class="dataForm" ref="form" :disabled="disabled" :model="formParameter" :inline="true" label-width="80px" :rules="rules">
					<el-row>
						<el-col :span="24">
							<el-form-item label="详情URL" prop="xqurl"><el-input v-model="formParameter.xqurl" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
					...
					<el-row>
						<el-col :span="24">
							<el-form-item label="描述" prop="ms"><el-input v-model="formParameter.ms" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
							<el-form-item label="元数据主键" prop="ysjzj"><el-input v-model="formParameter.ysjzj" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
					...
					<el-row>
						<el-col :span="24">
							<el-form-item label="是否手写签名：0-否、1-是" prop="sfsxqm"><el-input v-model="formParameter.sfsxqm" autocomplete="off"></el-input></el-form-item>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
