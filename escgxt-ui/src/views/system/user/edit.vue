				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="生日" prop="birth">
							<el-date-picker v-model="formParameter.birth" type="date" placeholder="选择日期" value-format="yyyy-MM-dd"></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="性别" prop="sex">
							<select-option-dictionary v-model="formParameter.sex" dkey="user-sex" :multiple="false" :stringMode="true"></select-option-dictionary>
						</el-form-item>
						<!-- <el-form-item label="性别" prop="sex">
							<el-select v-model="formParameter.sex" placeholder="请选择">
				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="头像" prop="head">
							<image-upload v-model="formParameter.head" :isBase64="true" statisPath="/icon/head"></image-upload>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
