<template>
	<div class="tab-body">
		...
		<div class="operator">
			<el-button type="primary" icon="el-icon-plus" @click="toSave()" v-has-permission-code-and="'000000000005'">添加</el-button>
		...
		<div class="dataTable autoFlex" v-if="listData">
			<qlh-table class="table" ref="userTable" :data="listData.records" stripe border height="auto" @selection-change="selectionChange"
			 v-loading="listLoading" :tableToolButton="tableToolButton" :excelProp="excelProp">
				...
				<qlh-table-column prop="dname" label="部门" sortable></qlh-table-column>
				...
				<qlh-table-column prop="lname" label="登录名" sortable></qlh-table-column>
				...
				<qlh-table-column prop="birth" label="生日"></qlh-table-column>
