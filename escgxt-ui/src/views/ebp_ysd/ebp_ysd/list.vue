	...
	<div class="tab-body">
        ...
        <div class="dataTable autoFlex" v-if="listData">
			<el-table class="table" :data="listData.records" stripe border height="auto" @selection-change="selectionChange" v-loading="listLoading">
						...
						<el-table-column prop="dhsj" label="到货时间"></el-table-column>
						<el-table-column prop="isSuccess" label="是否验收：0-否、1-是"></el-table-column>
						<el-table-column prop="yszt" label="验收状态"></el-table-column>
						<el-table-column prop="yssqfj" label="验收申请附件"></el-table-column>
						<el-table-column prop="zsysbg" label="正式验收报告"></el-table-column>
