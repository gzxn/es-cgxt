<template>
	<div class="tab-body">
				...
				<qlh-table-column label="操作" fixed="right" width="200px">
					<template slot-scope="scope">
						<div class="dataTable-operator">
						    ...
						    <el-button v-has-permission-code-and="'4000025001'" size="mini" type="primary" icon="el-icon-edit" @click="toHtDraft(scope.$index, scope.row)">拟定合同</el-button>
							<!-- <el-button v-has-permission-code-and="'4000025001'" size="mini" type="primary" icon="el-icon-edit" @click="toUpdate(scope.$index, scope.row)">拟定合同</el-button> -->
		...
		<cgsqDetail ref="cgsqDetail"></cgsqDetail>
	</div>
</template>
<script>
	import addForm from './addForm.vue'
	import cgsqDetail from	'../../ebp_cgsq/ebp_cgsq/shForm.vue'
	...
	export default {
		...
		methods: {
			...
			toUpdate(index, row) {
				...
				this.$refs.addForm.open(editParameter, '编辑', false, '80%');
			},
			//去详情
			toDetail(index, row) {
				let detailParameter = {
				...
				this.$refs.cgsqDetail.open(detailParameter, '详情', true, '80%', false);
			},
			//拟定合同
			toHtDraft(index, row) {
				let addParameter = {
				...
				this.$refs.addForm.open(addParameter, '拟定合同', false, '80%');
			},
			//删除
			remove(index, row) {
				let parameter = {
