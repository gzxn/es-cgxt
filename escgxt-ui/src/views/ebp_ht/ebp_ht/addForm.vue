		...
		methods: {
				...
				init() {
					...
					if (this.parameter.id) {
						...
						htApi.toHtDraft(parameter, response => {
							this.formParameter = response.data;
							this.cgsqFormParameter = response.data.cgsqParameter;
							this.cgsqqdFormParameter = response.data.cgsqqdParameter;
							this.jfsyFormParameter = response.data.jfsyParameter;
							this.zbjgFormParameter = response.data.zbjgParameter;
							if (response.data.htParameter != undefined) {
								this.htFormParameter = response.data.htParameter;
							} else {
								this.htFormParameter.htje = this.zbjgFormParameter.cjjg;
								this.htFormParameter.jfly = this.jfsyFormParameter.ysmc;
								this.htFormParameter.xmfzr = this.cgsqFormParameter.xmfzr;
								this.htFormParameter.xmfzrdh = this.cgsqFormParameter.lxrdh;
								this.htFormParameter.cjgys = this.zbjgFormParameter.cjgys;
								this.htFormParameter.gyslxr = this.zbjgFormParameter.gyslxr;
								this.htFormParameter.gyslxdh = this.zbjgFormParameter.gyslxdh;
								this.htFormParameter.cgjg = '采购成功';
								this.htFormParameter.jgid = this.zbjgFormParameter.id;
								this.htFormParameter.xmfzrid = this.cgsqFormParameter.crer;
								this.htFormParameter.gysid = this.zbjgFormParameter.gysid;
							}
