	...
	<div class="tab-body">
        ...
        <div class="dataTable autoFlex" v-if="listData">
			<el-table class="table" :data="listData.records" stripe border height="auto" @selection-change="selectionChange" v-loading="listLoading">
						...
						<el-table-column prop="zbxmId" label="招标项目id"></el-table-column>
						...
						<el-table-column prop="kpbdd" label="开标与评标地点"></el-table-column>
						<el-table-column prop="zbdzl" label="招标公告地址栏"></el-table-column>
						<el-table-column prop="kbrq" label="开标日期"></el-table-column>
						<el-table-column prop="bmkssj" label="报名开始时间"></el-table-column>
						<el-table-column prop="bmjssj" label="报名结束时间"></el-table-column>
						<el-table-column prop="isFb" label="是否已发布：0-否、1-是"></el-table-column>
						<el-table-column prop="isGz" label="是否更正：0-否、1-是"></el-table-column>
						<el-table-column prop="isBg" label="是否变更：0-否、1-是"></el-table-column>
						<el-table-column prop="isStop" label="是否暂停公告：0-否、1-是"></el-table-column>
						<el-table-column prop="isWcbg" label="是否完成变更：0-否、1-是"></el-table-column>
...
import api from '@/api/ebp_zbgg/ebp_zbgg/ebp_zbgg.js';
export default {
	name: 'ebp_zbgg',
	components: {
		edit
