	...
	<div class="tab-body">
        ...
        <div class="dataTable autoFlex" v-if="listData">
			<el-table class="table" :data="listData.records" stripe border height="auto" @selection-change="selectionChange" v-loading="listLoading">
						...
						<el-table-column prop="cgsqid" label="采购申请id"></el-table-column>
						<el-table-column prop="jflyid" label="经费来源id"></el-table-column>
						<el-table-column prop="syje" label="使用金额(元)"></el-table-column>
						<el-table-column prop="ysbm" label="预算编码"></el-table-column>
						<el-table-column prop="ysmc" label="预算名称"></el-table-column>
						<el-table-column prop="jfType" label="经费类型"></el-table-column>
						<el-table-column prop="isNdysnzj" label="是否为年度预算内资金：0-否、1-是"></el-table-column>
