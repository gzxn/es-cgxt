				...
				<qlh-table-column label="操作" fixed="right" width="150px">
					<template slot-scope="scope">
						<div class="dataTable-operator">
							<el-button v-has-permission-code-and="'3000024010'" size="mini" icon="el-icon-search"@click="toDetail(scope.$index, scope.row)">查看</el-button>
						    <el-button v-has-permission-code-and="'3000025010'" size="mini" icon="el-icon-edit" type="primary" @click="toUpdate(scope.$index, scope.row)">审核</el-button>
