        ...
        <div class="dataTable autoFlex" v-if="listData">
			<qlh-table class="table" :data="listData.records" stripe border height="auto" @selection-change="selectionChange" 
				v-loading="listLoading" :tableToolButton="tableToolButton" :excelProp="excelProp">
						...
						<!-- <qlh-table-column prop="sbbmId" label="申报部门名称" v-if="false"></qlh-table-column> -->
						<!-- <qlh-table-column prop="xmfzryhm" label="项目负责人用户名"></qlh-table-column> -->
						<!-- <qlh-table-column prop="xmfzr" label="项目负责人"></qlh-table-column> -->
						<!-- <qlh-table-column prop="lxr" label="联系人"></qlh-table-column> -->
						<!-- <qlh-table-column prop="lxryhm" label="联系人用户名"></qlh-table-column> -->
						<!-- <qlh-table-column prop="zzxs" label="组织形式"></qlh-table-column> -->
						<!-- <qlh-table-column prop="cgfs" label="采购方式"></qlh-table-column> -->
						<!-- <qlh-table-column prop="cgzxr" label="采购执行人"></qlh-table-column> -->
				...
				<qlh-table-column label="操作" fixed="right" width="200px">
					<template slot-scope="scope">
						<div class="dataTable-operator">
							<el-button v-has-permission-code-and="'3000014005'" size="mini" icon="el-icon-search"@click="toDetail(scope.$index, scope.row)">详情</el-button>
						    <el-button v-has-permission-code-and="'3000012005'" size="mini" icon="el-icon-edit" @click="toUpdate(scope.$index, scope.row)">编辑</el-button>
                            <el-button v-has-permission-code-and="'3000013005'" size="mini" icon="el-icon-delete" type="danger" @click="remove(scope.$index, scope.row)">删除</el-button>
                        </div>
					</template>
				</qlh-table-column>
			</qlh-table>
	...
	export default {
		...
		methods: {
			...
			toDetail(index, row) {
				...
				// this.$refs.editForm.open(detailParameter, '详情', true, '80%');
