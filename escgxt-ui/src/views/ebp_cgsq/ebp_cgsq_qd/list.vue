	...
	<div class="tab-body">
        ...
        <div class="dataTable autoFlex" v-if="listData">
			<el-table class="table" :data="listData.records" stripe border height="auto" @selection-change="selectionChange" v-loading="listLoading">
						...
						<el-table-column prop="cgsqid" label="采购项目id"></el-table-column>
						<el-table-column prop="hwbh" label="流水号"></el-table-column>
						<el-table-column prop="mc" label="设备名称"></el-table-column>
						<el-table-column prop="pmmc" label="品目名称"></el-table-column>
						<el-table-column prop="pmbm" label="品目编码"></el-table-column>
						...
						<el-table-column prop="cssm" label="参数"></el-table-column>
						<el-table-column prop="sbr" label="申报人"></el-table-column>
						<el-table-column prop="sbryhm" label="申报人用户名"></el-table-column>
						<el-table-column prop="sbbm" label="申报部门"></el-table-column>
						<el-table-column prop="sbbmmm" label="申报部门编码"></el-table-column>
						<el-table-column prop="sbrq" label="申报日期"></el-table-column>
						...
						<el-table-column prop="cjdj" label="成交单价"></el-table-column>
						<el-table-column prop="cjzj" label="成交总价"></el-table-column>
						<el-table-column prop="cgzxr" label="采购执行人"></el-table-column>
						<el-table-column prop="isPack" label="是否打包"></el-table-column>
						<el-table-column prop="isTask" label="是否分配任务：0-否、1-是"></el-table-column>
						<el-table-column prop="isDjjg" label="是否登记结果：0-否、1-是"></el-table-column>
						<el-table-column prop="isJggs" label="是否结果公示：0-否、1-是"></el-table-column>
...
import api from '@/api/ebp_cgsq/ebp_cgsq_qd/ebp_cgsq_qd.js';
export default {
	name: 'ebp_cgsq_qd',
	components: {
		edit
