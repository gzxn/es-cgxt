				...
				<el-card class="box-card userInfo">
					...
					<el-row class="userInfo-body ">
						<el-col :span="12" class="userHead">
							...
							<image-upload @change="change" :limiter="10*2" v-model="formParameter.head" :isBase64="true" statisPath="/icon/head"></image-upload>
						...
						<el-col :span="12" class="info">
							...
							<div>
								...
								<span id="rname" name="rname">{{ formParameter.roleNames}}</span>
							</div>
							<div>
								<label>部门:</label>
								<!-- <span id="dname" name="dname">{{ formParameter.dname }}</span> -->
								<span id="dname" name="dname">{{ formParameter.departmentNames }}</span>
							</div>
							<div>
								<label>邮件:</label>
			...
			<el-col :span="12">
				<el-card class="box-card" :body-style="{height:'80%'}">
					...
					<div class="dataTable autoFlex" v-if="listData" style="height: 100%;">
						<el-table class="table" style="height: 100%;" :data="listData.records" stripe border height="auto"
